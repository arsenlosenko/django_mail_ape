...
class DeleteMailingList(LoginRequiredMixin, UserCanUseMailingList, DeleteView):
    model = MailingList
...
class SubscribeToMailingListView(CreateView):
    ...
    def get_success_url(self):
        return reverse(
            'mailinglist:subscriber-thankyou',
            kwargs={
...
class ThankForSubscriptionView(DetailView):
    model = MailingList
...
class ConfirmSubscriptionView(DetailView):
    ...
    def get_object(self, queryset=None):
        subscriber = super().get_object(queryset)
...
class CreateMessageView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse(
            'mailinglist:manage-mailinglist',
