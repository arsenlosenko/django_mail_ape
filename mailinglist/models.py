...
class SubscribeMessageManager(models.Manager):
    def create_from_message(self, message):
        ...
        return [
            self.create(message=message, subscriber=subsciber)
...
class SubscriberMessage(models.Model):
    ...
    objects = SubscribeMessageManager()
    ...
    def send(self):
        tasks.send_subscriber_message.delay(self)
